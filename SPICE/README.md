...
- Suite result: `43` total steps, `0` failed
...
|---|---|---|---|
| Simulation execution / convergence | **PASS** | 43 suite steps, 0 failed. | nan |
...
| Reference rails VREF_2V048 / VREF_1V024 | **PASS** | Baseline VREF_2V048=2.048..2.048 V; VREF_1V024=1.024..1.024 V. | nan |
| Core LIF oscillation / threshold / AP / reset / Spike_Out | **PASS** | Baseline AP=27, Reset_Window=27, Spike_Out=27; Vm_Int=0.4637..0.8832 V. | nan |
| Quiet subthreshold operating point | **PASS** | Quiet-subthreshold AP_rising_edges=0; Vm_Int_max=0.51 V. | nan |
...
| Synapse midpoint zero-effect | **PASS** | Midpoint minus quiet Vm_Int_max delta=0.7374 mV; AP_rising_edges=0. | nan |
| Excitatory synapse sign | **PASS** | Excitatory minus quiet Vm_Int_max delta=118.3 mV. | nan |
| Inhibitory synapse sign | **PASS** | Baseline AP period=53.89 ms; inhibitory AP period=70.03 ms. | nan |
...
| RV1 leak/reference sweep | **PASS** | First sweep AP edges=0; last sweep AP edges=18. | nan |
| RV2 leak-rate sweep | **PASS** | Finite AP mean periods observed: 53.81 ms, 28.07 ms. | nan |
...
| Synaptic sign/weight sweep | **PASS** | 5 synaptic sign/weight sweep runs completed. | nan |
...
#### Baseline self-spiking

![Baseline self-spiking — Vm_Int and Vm_Ext](LIFeling_pyspice_output/LIFeling_updated_02_baseline_self_spiking_coin_rv0p70_0p50_0p80_0p30_vb3_t1p5_d99654c1_vmint_vmext.png)

![Baseline self-spiking — full trace set](LIFeling_pyspice_output/LIFeling_updated_02_baseline_self_spiking_coin_rv0p70_0p50_0p80_0p30_vb3_t1p5_d99654c1.png)

#### Debug self-spiking

![Debug self-spiking — Vm_Int and Vm_Ext](LIFeling_pyspice_output/LIFeling_updated_03_debug_self_spiking_short_rv0p70_0p50_0p80_0p30_vb3_t400m_7adaaf98_vmint_vmext.png)

![Debug self-spiking — full trace set](LIFeling_pyspice_output/LIFeling_updated_03_debug_self_spiking_short_rv0p70_0p50_0p80_0p30_vb3_t400m_7adaaf98.png)
...
![Synapse midpoint zero-effect — full trace set](LIFeling_pyspice_output/LIFeling_updated_06_synapse_midpoint_zero_effect_single_rv0p35_0p50_0p80_0p30_vb3_t400m_syn1234_b8d2aa40.png)
...
![Excitatory synapse — full trace set](LIFeling_pyspice_output/LIFeling_updated_07_synapse_excitatory_single_high_rv0p35_0p50_0p80_0p30_vb3_t400m_syn1234_079c8a68.png)
...
![Inhibitory synapse — full trace set](LIFeling_pyspice_output/LIFeling_updated_08_synapse_inhibitory_single_low_rv0p70_0p50_0p80_0p30_vb3_t500m_syn1234_2408b779.png)

#### Positive external stimulus
...
![Positive external stimulus — full trace set](LIFeling_pyspice_output/LIFeling_updated_09_external_stimulus_positive_subthreshold_rv0p35_0p50_0p80_0p30_vb3_t400m_d6b0544f.png)

#### Cold start

![Cold start — Vm_Int and Vm_Ext](LIFeling_pyspice_output/LIFeling_updated_04_cold_start_self_spiking_coin_rv0p70_0p50_0p80_0p30_vb3_t800m_d0c63a1e_vmint_vmext.png)

![Cold start — full trace set](LIFeling_pyspice_output/LIFeling_updated_04_cold_start_self_spiking_coin_rv0p70_0p50_0p80_0p30_vb3_t800m_d0c63a1e.png)
